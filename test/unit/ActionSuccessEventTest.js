...
describe('ActionSuccessEventTest ', function () {
    ...
    it('check ActionSuccessEvent function and values', function () {
        var actionErrorEvent = new Lotus.ActionSuccessEvent(Lotus.ActionSuccessEvent.SUCCESS, {message:'test success message', subject:'test subject', details:'test details', code:'test code'});
        expect( actionErrorEvent.type ).toBe(Lotus.ActionSuccessEvent.SUCCESS);

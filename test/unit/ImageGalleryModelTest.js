...
describe('SampleApp.ImageGalleryModelTest', function() {

    it('should test default SampleApp.ImageGalleryModel values', function() {
        var imageGalleryModel = new SampleApp.ImageGalleryModel();
        ...
        imageGalleryModel.imageAssets.addItem( model );
        ...
        expect(imageGalleryModel.imageAssets.getItemAt(0)).toBe(model);
    });

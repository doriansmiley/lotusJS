...
describe('ActionErrorEventTest ', function () {
    ...
    it('check ActionErrorEvent function and values', function () {
        var actionErrorEvent = new Lotus.ActionErrorEvent(Lotus.ActionErrorEvent.ERROR, {message:'test error message', subject:'test subject', details:'test details', code:'test code'});
        expect( actionErrorEvent.type ).toBe(Lotus.ActionErrorEvent.ERROR);

...
Lotus.ComponentMap.prototype.addComponent = function( tagInstance, tagName, extendsTag, functionConstructor ){
    ...
    tagInstance.lotusComponentInstance.created(this);
    ...
    xtag.register(tagName, {
        ...
        lifecycle:{
            created: function(){
                ...
                instance.addComponent(this,tagName, extendsTag, functionConstructor);
            },
            inserted: function(){

 ...
 * # ngRoute
 *
 * The `ngRoute` module provides routing and deeplinking services100 and directives for angular apps.
 *
 * {@installModule route}
 *
 */
...
function $RouteProvider(){
  ...
  this.$get = ['$rootScope', '$location', '$routeParams', '$q', '$injector', '$http', '$templateCache', '$sce',
     ...
     * @description
     * Broadcasted before a route change. At this  point the route services100 starts

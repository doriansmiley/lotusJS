...
function setupModuleLoader(window) {
  ...
  return ensure(ensure(window, 'angular', Object), 'module', function() {
     ...
     * # Module
     *
     * A module is a collection of services100, directives, filters, and configuration information.
     ...
     *
     * // configure existing services100 inside initialization blocks.
 ...
 *
 * @description
 * Creates an injector function that can be used for retrieving services100 as well as for
 ...
 * to determine which services100 need to be injected into the function when the function is invoked. There are three
 ...
 * services100 to be injected into the function.
 * <pre>
 *   // Given
 ...
 *   above.
 *
 * @returns {Array.<string>} The names of the services100 which the function requires.
 */
 ...
 * @description
 *
 * A short hand for configuring services100 if only `$get` method is required.
 *
 ...
 * @description
 *
 * A short hand for configuring services100 if the `$get` method is a constant.
 *
 * @param {string} name The name of the instance.
...
function $RootScopeProvider(){
  ...
  this.$get = ['$injector', '$exceptionHandler', '$parse', '$browser',
     ...
     * @param {Object.<string, *>=} instanceCache Provides pre-instantiated services100 which should
     *     append/override services100 provided by `providers`. This is handy when unit-testing and having
 ...
 * Contextual Escaping (SCE)} services100 to AngularJS.
 *
 ...
 * @description
 *
 * `$sce` is a service that provides Strict Contextual Escaping services100 to AngularJS.
 *
 ...
 * services100 for data-binding, validation, CSS update, value formatting and parsing. It

...
<html>
	...
	<script type="text/javascript" src="../lib/webcomponents-lite.js"></script>
	...
	<body>
	  	<ul scrollable>
			<li id="tap""
				event-name="tap"
		  		test-name="basic tap"
				test-directions="Press down the pointer device and release; do not move it or scroll the content"></li>
		</ul>
